...
<?php }?>
           <?php if($user=='1'){ ?><div class="row"><div class="col-lg-6" style="padding-bottom:20px;"><input class="form-control" autocomplete="off" name="results" size="20" id="keyword"  placeholder="Search Overall"><ul id="content" class="tt-dropdown-menu display_none"></ul></div><div class="col-lg-3 pull-right" style="padding-bottom:10px;"><Button href="" class="btn btn-default"  type="button" title="Add" data-toggle="modal" data-target="#addcat"><i class="fa fa-globe"></i> Add New Website Category</button></div></div><?php } ?>
             ...
             <?php if($user=='4' ){ ?><div class="row"><div class="col-lg-3 pull-right" style="padding-bottom:10px;"><Button href="" class="btn btn-default"  type="button" title="Add" data-toggle="modal" data-target="#addcat"><i class="fa fa-globe"></i> Add New Website Category</button></div></div><?php } ?>
