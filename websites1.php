...
Command Centre</a>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="Technology.php"><i class="fa fa-code"></i> Technical</a></li>
...
//Select Query
$i=0;
$sql = mysqli_query($link, "Select * FROM `genre_to_category` WHERE `genre_id`= 1 ") or die(mysqli_error($link));
          ...
          <div>
              ...
              <?php
               ...
               ?>
                 ...
                 <a href="javascript:void(0);"><i data-toggle="collapse" data-target="#<?php echo $i;?>" class="fa fa-cog fa-lg grey pull-right"></i></a>
