...
Command Centre</a>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="typo.php"><i class="fa fa-pencil"></i> Typography</a></li>
...
<?php }?>
           <Button href="" class="btn btn-default"  type="button" title="Add" data-toggle="modal" data-target="#addcat"><i class="fa fa-pencil"></i> Add New TypoGraphy Category</button>
...
//Select Query
$i=0;
$sql = mysqli_query($link, "Select * FROM `genre_to_category` WHERE `genre_id`= 3 ") or die(mysqli_error($link));
...
?>
     <article class="white-panel"><img src="<?php echo 'img/typo_cat/'.$image;?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>"/>
          <div>
              <br>
              ...
              <?php
                ...
                $sql1 = mysqli_query( $link , "Select * FROM `category_to_content` WHERE `category_id`= '$id' ") or     die(mysqli_error($link));
                  while( $row1 = mysqli_fetch_array($sql1, MYSQLI_BOTH)){
                      ...
                      $image1 = $row1['image'];
                  ?>
                  <div class="search"><p class="abc"><a href="<?php echo 'img/typos/'.$image1;?>" title="<?php echo $name; ?>" target="_blank" ><img src="<?php echo 'img/typos/'.$image1;?>" /></a><a href="<?php echo $link; ?>" target="_blank" ><br><br><?php echo $name; ?></a> - <?php echo $content; ?> </p><br></div>  
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i> Add New TypoGraphy Category</h4>
      </div>
      <div class="modal-body">
          <br>
                 <form action="typo_cat_process.php" method="post" role="form" enctype="multipart/form-data">
                    <div class="input-group">
...
<!-- Modal for adding new font -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i> Add Font</h4>
      </div>
      <div class="modal-body">
          <br>
                <form action="typo_cont_process.php" method="POST" role="form" enctype="multipart/form-data" >
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="font_name" class="form-control" placeholder="font-name">
                    </div><br>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-link"></i></span>
                        <input type="text" name="href"  class="form-control" placeholder="https://www.google.com">
                    </div><br>  
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-tag"></i></span>
                        <input type="text" name="tag" class="form-control" placeholder="font feel or using area">
                    </div>
                                        <br>  
