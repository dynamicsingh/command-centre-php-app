...
if(isset($_FILES["photo"]["error"])){
    ...
    exit();
        ...
        if(in_array($filetype, $allowed)){
            ...
            if(file_exists("img/typos/" . $new_file_name)){
                echo $_FILES["photo"]["name"] . " is already exists.";
            } else{
                move_uploaded_file($_FILES["photo"]["tmp_name"], "img/typos/" . $new_file_name);
					
	mysqli_query($link, "INSERT INTO category_to_content( category_id, name_heading, link, content, image)
	VALUES('$id', '$name', '$href', '$tag', '$new_file_name')") or die("Error " . mysqli_error($link));
